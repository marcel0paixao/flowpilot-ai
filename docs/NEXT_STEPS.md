...
- Start the front-end MVP.
- Build login and workspace context using the existing auth/workspace APIs.
- Build workflow list/detail using the existing workflow APIs.
- Build execution request and execution detail using the new summary endpoint.
