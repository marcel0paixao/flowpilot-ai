...
- Start modeling node-level execution progress with persisted per-node attempts/results.
- Add node lifecycle event contracts after the first persisted node execution shape is agreed.
