...
- Add a compact execution summary endpoint or response shape for front-end use.
- Decide whether the first front-end should poll execution details or use a lightweight server-sent events/websocket layer later.
- Add a user-facing workflow definition read shape optimized for rendering nodes/edges.
