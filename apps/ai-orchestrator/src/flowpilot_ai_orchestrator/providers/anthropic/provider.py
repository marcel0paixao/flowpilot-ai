...
class AnthropicChatCompletionsClient(Protocol):
    def create(
        self,
        *,
        model: str,
...
class AnthropicChatClient(Protocol):
    completions: AnthropicChatCompletionsClient
        ...
        *,
        ...
        if config.credential_id is None:
            raise ProviderConfigurationError(
                "Anthropic provider requires credentialId",
